...
Usage:
    python scripts/dev-server.py [options]
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python scripts/dev-server.py                           # Start with defaults
  python scripts/dev-server.py --port 8080               # Custom port
  python scripts/dev-server.py --no-reload               # Disable hot-reload
  python scripts/dev-server.py --log-level DEBUG         # Debug logging
  python scripts/dev-server.py --reload-dirs tests,docs  # Watch additional dirs
"""
    )

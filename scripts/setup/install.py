...
Usage:
    ./bin/mcp-jive setup environment [options]
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: ./bin/mcp-jive dev <command>")
...
'''
    ...
    def print_next_steps(self):
        ...
        print(f"   {Colors.BLUE}./bin/mcp-jive dev server{Colors.END}")
        
        print(f"\n3. Run tests:")
        print(f"   {Colors.BLUE}./bin/mcp-jive dev test{Colors.END}")
        
        print(f"\n4. Format code:")
        print(f"   {Colors.BLUE}./bin/mcp-jive dev format{Colors.END}")
        
        print(f"\n5. Check code quality:")
        print(f"   {Colors.BLUE}./bin/mcp-jive dev lint{Colors.END}")
        
        print(f"\n{Colors.YELLOW}📖 See docs/ for detailed guides{Colors.END}")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  ./bin/mcp-jive setup environment                    # Basic setup
  ./bin/mcp-jive setup environment --verbose          # Verbose output
  ./bin/mcp-jive setup environment --reset            # Reset existing environment
  ./bin/mcp-jive setup environment --no-editor        # Skip editor setup
"""
    )
